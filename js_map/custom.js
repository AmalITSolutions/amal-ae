...
$(document).ready(function() {
	...
	$(function() {
		"use strict";		
		function initialize() {
			var myLatlng = new google.maps.LatLng(25.2558498, 55.3016661);
			var mapOptions = {
				zoom: 8,  
			...
			'<p class="bgheading"><strong>AMAL IT Solutions</strong></p>'+
			'<div>M120, Al Attar Grand,</div>'+
			'<div>Khaleed Bin Al Waleed Road,</div>'+
			'<div>Dubai, United Arab Emirates</div>'+
			'<div>PO. Box: 31998</div>'+
			'<div>+971 4 3599916</div>'+
			'<div>info@amalit.ae</div>'
